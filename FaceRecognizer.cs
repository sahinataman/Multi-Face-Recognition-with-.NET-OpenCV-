...
namespace Emgu.CV
{
   ...
   public class FaceRecognizer
   {
      ...
      {
         Debug.Assert(images.Length == labels.Length, "Görüntü sayýsý etiketlerin sayýsýna eþit olmalýdýr");
         Debug.Assert(eigenDistanceThreshold >= 0.0, "Eigen-uzaklýgý her zaman eþik düzeyinde olmalýdýr >= 0.0");
